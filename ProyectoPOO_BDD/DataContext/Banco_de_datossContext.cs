...
{
    public partial class Banco_de_datossContext : DbContext
    {
        public Banco_de_datossContext()
        {
        }

        public Banco_de_datossContext(DbContextOptions<Banco_de_datossContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=Banco_de_datoss;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cabina>(entity =>
            {
                entity.HasKey(e => e.IdCabina)
                    .HasName("PK__CABINA__CC13A1A0E61DABEF");
            ...
            modelBuilder.Entity<CabinaxEmpleado>(entity =>
            {
                entity.HasKey(e => e.IdCabinaxempleado)
                    .HasName("PK__CABINAxE__36725A3B55D2731D");
            ...
            modelBuilder.Entity<Citum>(entity =>
            {
                entity.HasKey(e => e.IdCita)
                    .HasName("PK__CITA__6A1686E9EDD88B66");
            ...
            modelBuilder.Entity<Ciudadano>(entity =>
            {
                entity.HasKey(e => e.Dui)
                    .HasName("PK__CIUDADAN__D876F1BEBBB37923");
            ...
            modelBuilder.Entity<EfectoSecundario>(entity =>
            {
                entity.HasKey(e => e.IdSecundario)
                    .HasName("PK__EFECTO_S__299A1A8718B093A1");
            ...
            modelBuilder.Entity<Empleado>(entity =>
            {
                entity.HasKey(e => e.IdIdentificador)
                    .HasName("PK__EMPLEADO__579505C7C549A851");
            ...
            modelBuilder.Entity<EmpleadoxCiudadano>(entity =>
            {
                entity.HasKey(e => e.IdEmpleadoxciudadano)
                    .HasName("PK__EMPLEADO__A93DC5D767C06E8E");
            ...
            modelBuilder.Entity<Enfermedad>(entity =>
            {
                entity.HasKey(e => e.IdEnfermedad)
                    .HasName("PK__ENFERMED__5E79491D6D3456C7");
            ...
            modelBuilder.Entity<Hora>(entity =>
            {
                entity.HasKey(e => e.IdHora)
                    .HasName("PK__HORA__9F3E025D11130A0A");
            ...
            modelBuilder.Entity<Identificador>(entity =>
            {
                entity.HasKey(e => e.IdNumero)
                    .HasName("PK__IDENTIFI__B5F8DC968E9FAAE5");
            ...
            modelBuilder.Entity<Lugar>(entity =>
            {
                entity.HasKey(e => e.IdLugar)
                    .HasName("PK__LUGAR__56BD467358A949D7");
            ...
            modelBuilder.Entity<Tipo>(entity =>
            {
                entity.HasKey(e => e.IdTipo)
                    .HasName("PK__TIPO__E151C964BF83EC1E");
            ...
            modelBuilder.Entity<Vacunacion>(entity =>
            {
                entity.HasKey(e => e.IdVacunacion)
                    .HasName("PK__VACUNACI__14A59DAD800B4FE9");
